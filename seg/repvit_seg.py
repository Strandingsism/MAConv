...
class RepViTSeg(nn.Module):
    def __init__(self, cfgs, num_classes=19):
        super(RepViTSeg, self).__init__()
...
def repvit_seg_m0_9(num_classes=19, pretrained=False):
    """
    RepViT-M0.9 for Cityscapes segmentation
    """
    cfgs = [
        # k, t, c, SE, HS, s 
        [3, 2, 48, 1, 0, 1],
    ...
    model = RepViTSeg(cfgs, num_classes=num_classes)
    return model

def repvit_seg_m1_0(num_classes=19, pretrained=False):
    """
    RepViT-M1.0 for Cityscapes segmentation
    """
    cfgs = [
        # k, t, c, SE, HS, s 
        [3, 2, 56, 1, 0, 1],
...
def repvit_seg_m1_5(num_classes=19, pretrained=False):
    """
    RepViT-M1.5 for Cityscapes segmentation
    """
    cfgs = [
        # k, t, c, SE, HS, s 
        [3, 2, 64, 1, 0, 1],
